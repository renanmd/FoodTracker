...
@IBDesignable class RatingControl: UIStackView {
    ...
    @objc func ratingButtonTapped(button: UIButton) {
        ...
        if selectedRating == rating {
            //If the selected star represents the currant rating, reset the rating to 0.
            rating = 0
        } else {
    ...
    private func setupButtons() {
        ...
        for index in 0..<starCount {
            ...
            //Ad the new button to the rating array.
    ...
    private func updateButtonsSelectionStates() {
        for (index, button) in ratingButtons.enumerated() {
            ...
            //Set the hint string for the ciurrently selected star.
